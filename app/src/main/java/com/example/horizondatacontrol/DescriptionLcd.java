...
public class DescriptionLcd extends AppCompatActivity {
    TextView textView1;
    ProgressBar pb;
    Button bt;
    ImageButton retmal;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_description_lcd);
        ...
        bt.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent i=new Intent(getApplicationContext(),LcdLearnActivity.class);
                startActivity(i);
            }
        });
        pb.setVisibility(View.VISIBLE);
        FirebaseDatabase database = FirebaseDatabase.getInstance();
        DatabaseReference myRef = database.getReference("EspaceDescription/lcd");
