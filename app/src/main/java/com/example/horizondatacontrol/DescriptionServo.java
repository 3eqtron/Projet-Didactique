...
public class DescriptionServo extends AppCompatActivity {
TextView textView1;
ProgressBar pb;
Button bt;
ImageButton retmal;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_description_servo);
        ...
        bt.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent i=new Intent(getApplicationContext(),ServoLearnActivity.class);
                startActivity(i);
            }
        });
        pb.setVisibility(View.VISIBLE);
        FirebaseDatabase database = FirebaseDatabase.getInstance();
        DatabaseReference myRef = database.getReference("EspaceDescription/Servo");
